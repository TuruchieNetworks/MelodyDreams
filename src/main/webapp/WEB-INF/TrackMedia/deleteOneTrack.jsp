		...
		<div class="mid-vert-margin"style="">
			<div class="">
				<h1  class="main-greeting-panel mid-vert-margin" style="">
					<a class="main-greeting word-slicer type-writer" href="/melodydreams/tracks/${oneSong.id}" style="">
						<c:out value="You Are About To Delete ${oneSong.trackTitle} From The Melody Dreams Console Today, ${currentDateTime} ${loggedInUser.firstName}!"/>
					</a>	
				</h1>
				<div id="selectedAudioName" style="margin-top: 10px;color:khaki;">
			        <div id="selectedAudioSnippet">		       
			       		<div style="font-size:16px;margin:5px 0;" id ="${oneSong.id}">					       		
				       		<!-- h3 id ="${oneSong.id}" style="font-size:16px;" onclick="detailedPlaypauseTrack(${JSON.stringify(oneSong.id)})" -->
				       		<div class="panelPlayPauseBtn" id="${oneSong.id}">
					      	<div class="lead panelPlaypauseBtn" style="" id="${oneSong.id}" onclick="playpauseTrack(this)">
								    <div id="${oneSong.id}" class="playpause-Track flex-panel btn btn-outline-warning panel-card" style="font-size:16px;padding:10px 0;width:100%;">
								        <p class="flex-panel sm-hor-margin" style="">
									        <c:out value="Play ${oneSong.trackTitle}"/>
									        <span id="${oneSong.id}" class="playpause-icon"></span> <!-- Span to hold the play/pause icon -->
									        <span id="${oneSong.id}" class="playpauseTrack panelPlaypause_btn">
					  	...
					  	<div class="leadShowcase panel-info" style="cursor:pointer;">
						   <div class="current-time prev-track" id="${oneSong.id}" style=""> 00.00</div>
						   <div class="panel-total-durations" id="${oneSong.id}" onclick="playpauseTrack(this)" style="font-size:12px;">00.00</div>
						   <div class="panel-remaining-durations next-track" id="${oneSong.id}" >00.00</div>
					  	</div>
									  
    			       <!-- Panel Slider Display -->
					  <!-- input id ="${oneSong.id}" type="range" min="1" max="100" value="0" class="seek_slider" onchange="seekTo(${JSON.stringify(oneSong.id)})" style="width:100%;text-align:center; margin:5px 0;"-->
					  <input id ="${oneSong.id}" type="range" min="1" max="100" value="0" class="id_seek_slider hidePanel" onchange="seekTo(this)" style="width:100%;text-align:center; margin:5px 0;">
		  			  <div class="hidePanel">
			  			  <input id ="${oneSong.id}" type="range" min="1" max="100" value="0" class="panel_seek_slider hidePanel" onchange="songSeekTo(this)" style="width:100%;text-align:center; margin:5px 0;">
					  	  <input id ="sectionSlider_${oneSong.id}" type="range" min="1" max="100" value="0" class="seek_slider hidePanel sectionSlider" onchange="seekTo(this)" style="width:100%;text-align:center; margin:5px 0;">
					   </div>
					   <div class="leadShowcase slider_container btn btn-outline-success panel-info panel-car" style="">
						    ...
						    <div style="display:flex;">
							    <div id="total_duration_${oneSong.id}" class="total-durations" style="margin:0 5px">00.00</div>
							 </div>
							 <div style="display:flex;">
							    <span>Time Remaining: </span>
							    <div id="${oneSong.id}" class="remaining_durations" style="margin:0 5px">00.00</div>
							 </div>
			    	...
			    	<p id="audio-url">Audio URL: ${oneSong.audioFileName}</p> 
			   	</div>
				<form:form class="profileShowcase mid-hor-margin deleteForm footer-delete-form " method="POST" action="/melodydreams/delete/${oneSong.id}">
					...
					<div class="over-flow profileShowcase imageCover">
							...
							<div class="form-group bluebtn"style="">
							  	<div class="form-group flexCover" style="">
							    	<input type="submit" value="Delete ${oneSong.trackTitle } Today, ${currentDateTime}" class="leadShowcase submit-track" id="submitBtn"/>
