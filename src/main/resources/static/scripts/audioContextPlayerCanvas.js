...
// Declare audio context and canvas globally
...
const playTrack = () => {
    let audioTrack = new Audio(music_list[track_index].music);
    
    // Create a media element source node using the existing audio context
